...
export function PlatformNav({
  ...
  return (
    <header className="relative flex items-center gap-3 px-4 h-[52px] glass-header shrink-0 select-none z-20">
      {/* Logo */}
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-1.5 px-3 py-1.5 text-[11px] rounded-[var(--radius-sm)] transition-all ${
                isActive
      ...
      {/* Right side: Search */}
      <div className="relative shrink-0" style={{ width: 200, maxWidth: 200 }}>
        <svg
          className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3 h-3 text-[var(--muted)]"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <button
          onClick={onIngest}
          disabled={ingesting}
          className={`flex items-center gap-1 px-2.5 py-[5px] text-[10px] font-bold rounded-[var(--radius-sm)] transition-all ripple-btn ${
            ingesting
      ...
      <button
        ...
        className="relative w-7 h-7 flex items-center justify-center rounded-[var(--radius-sm)] text-[var(--muted)] hover:text-[var(--accent)] hover:bg-[var(--accent-surface)] transition-all shrink-0"
        title="알림"
      >
        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <button
        onClick={onShowHelp}
        className="w-7 h-7 flex items-center justify-center rounded-[var(--radius-sm)] text-[var(--muted)] hover:text-[var(--accent)] hover:bg-[var(--accent-surface)] transition-all text-[11px] font-bold shrink-0"
        title="단축키 도움말 (?)"
      >
        ?
      </button>
